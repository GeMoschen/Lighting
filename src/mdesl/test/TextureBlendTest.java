...
public class TextureBlendTest extends SimpleGame {
    ...
    public void create() throws LWJGLException {
        ...
        // in this example our texture1 won't change, so we can bind it once and
        // forget about it

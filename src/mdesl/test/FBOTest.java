...
public class FBOTest extends SimpleGame {
    ...
    protected void create() throws LWJGLException {
        ...
        try {
            ...
            // GL uses lower left coords... we use upper-left for textures, so
            // we need to flip Y
    ...
    protected void render() throws LWJGLException {
        ...
        // we don't need super.render() since it just clears the screen, and we
        // have that above
        ...
        // due to our different blend funcs we need to use RGBA to specify
        // opacity
